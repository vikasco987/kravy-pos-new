...
async function main() {
  ...
  console.log("Profile globalGstRate:", globalGstRate);
  console.log("Profile perProductTaxEnabled:", perProductEnabled);
  ...
  console.log("Difference:", totalBillTotal - (totalTaxableAll + totalGstAll));
}
